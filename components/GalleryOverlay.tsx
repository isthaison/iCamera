          ...
          <div className="px-10 pb-16 pt-6 bg-gradient-to-t from-black/80 to-transparent flex justify-around items-center gap-4">
            ...
            <button 
              onClick={() => {
                ...
                link.download = `iCamera_${selectedMedia.id}.${selectedMedia.url.startsWith('blob:') ? 'webm' : 'jpg'}`;
                link.click();
              }}
              className="flex flex-col items-center gap-2 group"
            >
              <div className="w-14 h-14 rounded-full bg-blue-500/20 text-blue-500 flex items-center justify-center group-active:scale-90 transition-all">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              </div>
              <span className="text-[9px] font-black uppercase tracking-widest text-blue-500/60">Tải xuống</span>
            </button>
